 ...
 */
public class TestautomationImageInitializer {

	private static TestautomationImageInitializer instance;

	private TestautomationImageInitializer() {
	}
	 ...
	 */
	public static TestautomationImageInitializer getInstance() {
		if (instance == null) {
			instance = new TestautomationImageInitializer();
		}
		return instance;
	}
	 ...
	 * {@link TestautomationImageRegistry}.
	 */
	public void initializeComponentImages() {
		for (TestautomationImageRegistry imageConfig : TestautomationImageRegistry.values()) {
