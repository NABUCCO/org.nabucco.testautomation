...
public class EngineCloneContentProvider extends
        AbstractElementPickerContentProvider {

    private Class<? extends Datatype> clazz;

    public EngineCloneContentProvider(Class<? extends Datatype> clazz) {
        this.clazz = clazz;
    }

    @Override
    public Object[] getElements(Object arg0) {
    	List<ProxyConfiguration> existingElements = EngineElementFactory.getExistingElements(clazz);
    	return existingElements.toArray();
    }
