...
AbstractBaseTypeWidgetCreator<Name> {
	 ...
	 */
	public Control createWidget(Composite parent, GridData data, Datatype datatype, Documentation documentation, ViewModel externalViewModel,
		...
		NTextMiniModel model = new NTextMiniModel(documentation, externalViewModel, datatype);
	...
	private Control layoutDocumentationComposite(NTextMiniModel model) {
		...
		// Create Label
		Label label = widgetFactory.createLabel(parent, masterBlockId + ".documentation");
		...
		documentationTextArea.setText(documentation.getValue());
