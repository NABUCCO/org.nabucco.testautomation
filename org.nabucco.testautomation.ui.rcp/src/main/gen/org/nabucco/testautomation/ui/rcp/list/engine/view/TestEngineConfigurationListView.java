...
/**
 * TestEngineConfigurationListView<p/>Search view for TestEngineConfigurations<p/>
 *
 * @author Steffen Schmidt, PRODYNA AG, 2010-06-30
 */
public class TestEngineConfigurationListView extends
        NabuccoComponentListView<TestEngineConfigurationListViewModel> {

    public static final String ID = "org.nabucco.testautomation.ui.list.engine.TestEngineConfigurationListView";

    public static final String TAB_TITLE = (ID + ".tabTitle");

    public static final String TITLE = (ID + ".title");

    /** Constructs a new TestEngineConfigurationListView instance. */
    public TestEngineConfigurationListView() {
        super();
        model = new TestEngineConfigurationListViewModel();
    }
