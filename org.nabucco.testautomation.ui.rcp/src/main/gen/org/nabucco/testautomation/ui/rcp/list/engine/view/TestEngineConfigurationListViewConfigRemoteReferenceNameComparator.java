 ...
 * @author Undefined
 */
public class TestEngineConfigurationListViewConfigRemoteReferenceNameComparator implements
    ...
    public int compare(TestEngineConfiguration object1, TestEngineConfiguration object2) {
        return object1.getRemoteReferenceName().compareTo(object2.getRemoteReferenceName());
    }
}
