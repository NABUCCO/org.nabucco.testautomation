...
/**
 * TestEngineConfigurationListViewWidgetFactory<p/>Search view for TestEngineConfigurations<p/>
 *
 * @author Steffen Schmidt, PRODYNA AG, 2010-06-30
 */
public class TestEngineConfigurationListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new TestEngineConfigurationListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public TestEngineConfigurationListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
