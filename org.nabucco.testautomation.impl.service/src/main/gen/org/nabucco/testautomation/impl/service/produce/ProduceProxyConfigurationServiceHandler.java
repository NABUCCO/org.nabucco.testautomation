...
/**
 * ProduceProxyConfigurationServiceHandler<p/>TestEngineConfiguration produce service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-19
 */
public abstract class ProduceProxyConfigurationServiceHandler extends ServiceHandlerSupport
        implements ServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.impl.service.produce.ProduceProxyConfigurationServiceHandler";

    /** Constructs a new ProduceProxyConfigurationServiceHandler instance. */
    public ProduceProxyConfigurationServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<TestEngineConfigurationMsg> invoke(
        ...
        try {
            ...
            msg = this.produceProxyConfiguration(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ProduceException
     */
    protected abstract TestEngineConfigurationMsg produceProxyConfiguration(EmptyServiceMessage msg)
            throws ProduceException;
