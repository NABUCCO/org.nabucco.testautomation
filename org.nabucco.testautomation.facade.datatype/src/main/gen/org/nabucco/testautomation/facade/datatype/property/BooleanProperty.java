...
public class BooleanProperty extends PropertyComponent implements Datatype {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.putAll(PropertyCache.getInstance().retrieve(PropertyComponent.class)
                .getPropertyMap());
        propertyMap.put(VALUE, PropertyDescriptorSupport.createBasetype(VALUE, BooleanValue.class,
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(BooleanProperty.getPropertyDescriptor(VALUE),
                this.value, null));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(VALUE) && (property.getType() == BooleanValue.class))) {
            this.setValue(((BooleanValue) property.getInstance()));
            return true;
        }
        return false;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(BooleanProperty.class)
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(BooleanProperty.class).getAllProperties();
    }
}
