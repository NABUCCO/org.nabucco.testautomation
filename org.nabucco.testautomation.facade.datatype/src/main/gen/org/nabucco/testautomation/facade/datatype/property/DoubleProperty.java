...
public class DoubleProperty extends PropertyComponent implements Datatype {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.putAll(PropertyCache.getInstance().retrieve(PropertyComponent.class)
                .getPropertyMap());
        propertyMap.put(VALUE, PropertyDescriptorSupport.createBasetype(VALUE, DoubleValue.class,
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(DoubleProperty.getPropertyDescriptor(VALUE),
                this.value, null));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(VALUE) && (property.getType() == DoubleValue.class))) {
            this.setValue(((DoubleValue) property.getInstance()));
            return true;
        }
        return false;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(DoubleProperty.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(DoubleProperty.class).getAllProperties();
    }
}
