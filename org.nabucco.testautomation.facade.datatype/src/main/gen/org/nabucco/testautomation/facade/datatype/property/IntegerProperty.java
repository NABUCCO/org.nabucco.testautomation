...
public class IntegerProperty extends PropertyComponent implements Datatype {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.putAll(PropertyCache.getInstance().retrieve(PropertyComponent.class)
                .getPropertyMap());
        propertyMap.put(VALUE, PropertyDescriptorSupport.createBasetype(VALUE, IntegerValue.class,
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(IntegerProperty.getPropertyDescriptor(VALUE),
                this.value, null));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(VALUE) && (property.getType() == IntegerValue.class))) {
            this.setValue(((IntegerValue) property.getInstance()));
            return true;
        }
        return false;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(IntegerProperty.class)
