...
public class SqlProperty extends PropertyComponent implements Datatype {
    ...
    private static final String[] PROPERTY_CONSTRAINTS = { "l0,100000;m0,1;" };
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.putAll(PropertyCache.getInstance().retrieve(PropertyComponent.class)
                .getPropertyMap());
        propertyMap.put(VALUE, PropertyDescriptorSupport.createBasetype(VALUE, SqlValue.class, 8,
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(SqlProperty.getPropertyDescriptor(VALUE), this.value,
                null));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(VALUE) && (property.getType() == SqlValue.class))) {
            this.setValue(((SqlValue) property.getInstance()));
            return true;
        }
        return false;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(SqlProperty.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(SqlProperty.class).getAllProperties();
    }
}
