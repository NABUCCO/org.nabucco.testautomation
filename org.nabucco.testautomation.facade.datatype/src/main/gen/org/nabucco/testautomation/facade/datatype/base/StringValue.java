...
public class StringValue extends NString implements Basetype {
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(StringValue.getPropertyDescriptor(PROPERTY_NAME).createProperty(this,
                this.getValue(), null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(StringValue.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(StringValue.class).getAllProperties();
    }
}
